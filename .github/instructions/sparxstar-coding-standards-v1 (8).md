...
| SCOPE | Stack: WordPress 6.9, PHP 8.2/8.3, JavaScript, GraphQL, TUS upload server, Cloudflare, Nginx, Varnish, Apache, PHP-FPM, MariaDB, Redis (Predis), OPcache, Digital Ocean. Sirus is the cross-repo authority layer referenced throughout. |
| :---- | :---- |
...
## **2.1  Version Contract**

| Component | Version | Constraint |
| :---- | :---- | :---- |
| WordPress | 6.9 fixed | No deprecated WP APIs. Required for Abilities and Consent API. |
| PHP | 8.2 → 8.3 compatible | Strict types required. No dynamic properties (8.2+ warning). |
| MariaDB | Current stable | No direct SQL interpolation. All queries parameterized. |
...
Applies to: WordPress 6.9, PHP 8.2/8.3, JavaScript, GraphQL, TUS, Cloudflare, Nginx, Varnish, MariaDB, Redis, Digital Ocean